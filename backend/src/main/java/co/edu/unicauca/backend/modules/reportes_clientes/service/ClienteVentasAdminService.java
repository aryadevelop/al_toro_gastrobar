package co.edu.unicauca.backend.modules.reportes_clientes.service;
...
import co.edu.unicauca.backend.modules.reportes_clientes.dto.response.ClienteResumenResponse;
...
import co.edu.unicauca.backend.modules.reportes_clientes.dto.response.VentaDetalleResponse;
import co.edu.unicauca.backend.modules.reportes_clientes.repository.ClienteAdminRepository;
import co.edu.unicauca.backend.modules.reportes_clientes.repository.VentaAdminRepository;
import co.edu.unicauca.backend.modules.reportes_clientes.repository.VentaAgrupadaAnioView;
import co.edu.unicauca.backend.modules.reportes_clientes.repository.VentaAgrupadaMesView;
...
public class ClienteVentasAdminService {
    ...
    private static final DateTimeFormatter FECHA_FORMATO = DateTimeFormatter.ofPattern("dd/MM/yyyy", Locale.forLanguageTag("es-CO"));
