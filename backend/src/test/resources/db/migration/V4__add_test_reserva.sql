-- Insertar una nueva reserva CONFIRMADA con pre-orden
WITH new_reserva AS (
    ...
    VALUES (13, 1, NULL, NOW() + INTERVAL '5 days', 2, 'Prueba de Anticipo y Devolucion', 'CONFIRMADA', 'BASICA', NOW())
...
SELECT comanda_id, p.producto_id, 2, p.producto_precio, 'Prueba'
FROM new_comanda
